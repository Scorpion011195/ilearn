        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <?php if(session('alertUpdatePassword')): ?>
                    <?php if(session('alertUpdatePassword')=='failPass'): ?>
                        <div>
                ...
                <form action="<?php echo e(utf8_encode(route('adminChangePassword'))); ?>" method="post">
                    <input type="hidden" name="_token" value="<?php echo e(utf8_encode(csrf_token())); ?>">
                    <div class="row margin-top">
                        <lable class="control-label col-sm-4 text-center-vertical">Mật khẩu cũ</lable>
                        <div class="col-sm-8 <?php echo $errors->has('profile-password-old') ? ' has-error' : ''; ?>">
                            <input type="password" name="profile-password-old" class="form-control" value="<?php echo old('profile-password-old'); ?>">
                        </div>
                    </div>
                    <?php if($errors->has('profile-password-old')): ?>
                      <div>
                        <div class="control-label col-sm-4 text-center-vertical"></div>
                        <div class="col-sm-8 <?php echo $errors->has('profile-password-old') ? ' has-error' : ''; ?>">
                          <div>
                              <p class="help-block"><span class="glyphicon glyphicon-warning-sign"></span>   <strong><?php echo $errors->first('profile-password-old'); ?></strong></p>
                          </div>
                        </div>
                      </div>
                    <?php endif; ?>
                    ...
                    <div class="row margin-top">
                        ...
                        <div class="col-sm-8 <?php echo $errors->has('profile-password-new') ? ' has-error' : ''; ?>">
                            <input type="password" name="profile-password-new" class="form-control" value="<?php echo old('profile-password-new'); ?>">
                        </div>
                    </div>
                    <?php if($errors->has('profile-password-new')): ?>
                      <div>
                        <div class="control-label col-sm-4 text-center-vertical"></div>
                        <div class="col-sm-8 <?php echo $errors->has('profile-password-new') ? ' has-error' : ''; ?>">
                          <div>
                              <p class="help-block"><span class="glyphicon glyphicon-warning-sign"></span>   <strong><?php echo $errors->first('profile-password-new'); ?></strong></p>
                          </div>
                        </div>
                      </div>
                    <?php endif; ?>
                    ...
                    <div class="row margin-top">
                        ...
                        <div class="col-sm-8 <?php echo $errors->has('profile-password-new-confirm') ? ' has-error' : ''; ?>">
                            <input type="password" name="profile-password-new-confirm" class="form-control" value="<?php echo old('profile-password-new-confirm'); ?>">
                        </div>
                    </div>
                    <?php if($errors->has('profile-password-new-confirm')): ?>
                      <div>
                        <div class="control-label col-sm-4 text-center-vertical"></div>
                        <div class="col-sm-8 <?php echo $errors->has('profile-password-new-confirm') ? ' has-error' : ''; ?>">
                          <div>
                              <p class="help-block"><span class="glyphicon glyphicon-warning-sign"></span>   <strong><?php echo $errors->first('profile-password-new-confirm'); ?></strong></p>
                          </div>
                        </div>
                      </div>
                    <?php endif; ?>
